...
let agregarAlCarrito = parseInt(
    prompt(
        "Ingresa el produco que deseas comprar: \n1-Camiseta \n2-Gorro \n3-Taza \n4-Llavero"
    )
);
...
while (seguirComprando === true) {
    ...
    if (decision === 1) {
        agregarAlCarrito = parseInt(
            prompt(
                "Ingresa el produco que deseas comprar: 1-Camiseta 2-Gorro 3-Taza 4-Llavero"
            )
        );
    } else if (decision === 2) {
...
alert(
    ...
    totalCompra +
    " Pero te espera un increible descuento."
);
